...
const Product = ({ post }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-between hover:scale-110 transition-all duration-200 ease-in gap-3 p-4 mt-10 ml-5 rounded-xl  hover:shadow-2xl shadow-black/5 dark:shadow-black/30 shadow-inner">
      <div>
